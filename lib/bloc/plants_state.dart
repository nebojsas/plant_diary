...
final serverPlantList = UnmodifiableListView<Plant>([
  ...
  Plant('plant 3', 'Type 1',
      imageUrl:
          'https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/small-plant-aglaonema-in-white-pot-on-desk-royalty-free-image-1580854625.jpg?crop=0.384xw:0.868xh;0.438xw,0.132xh&resize=980:*'),
...
class Plant {
  ...
  bool needsWater() => lastTimeWatered == null
      ? true
      : DateTime.now().difference(lastTimeWatered) > Duration(days: 2);
}
